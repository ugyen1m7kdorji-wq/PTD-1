...
document.addEventListener('contextmenu', (e) => {
  e.preventDefault();
  // Position first (off-hidden) so we can measure it, then clamp so it never
  // extends past the window's own edges. The pet window is small, fixed-size,
  // and has overflow:hidden with no scrollbars, so any unclamped overflow -
  // e.g. right-clicking in the lower/right part of the sprite - previously
  // clipped items like "Hide Snoopy" and "Quit" completely out of view and
  // out of reach.
